...
namespace UnitTestQ2
{
    internal class Program
    {
        ...
        start:
            Console.WriteLine("Enter a list of space-separated numbers or strings");
            ...
            foreach (string sThisString in sString)
            {
                ...
                try
                {
                    ...
                    nThisString = double.Parse(sThisString);
            ...
            foreach (string sThisString in sString)
            {
                ...
                aUnsorted[nUnsortedLength] = nThisString;
