...
namespace EditPerson
{
    ...
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            //CheckChanged for radio buttons in class group box
            ...
            //Sets the person.eGender to the gender checked on the radio buttons
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            if( this.typeComboBox.SelectedIndex == 0)
            {
                student = new Student();
                person = student;
                //student.eCollegeYear is set to class-related Radio Button
                if (this.froshRadioButton.Checked)
                {
                    student.eCollegeYear = collegeYear.freshman;
                }
            ...
            //person.eGender is set to Gender Radio Button
        ...
        //ClassRadioButton__CheckedChanged method
