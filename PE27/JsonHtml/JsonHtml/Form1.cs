...
namespace JsonHtml
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            StreamWriter writer = new StreamWriter("C:/Users/timot/OneDrive/Documents/myIGME/PE27/students.json");
            writer.Write(s);
            writer.Close();

            writer = new StreamWriter("C:/Users/timot/OneDrive/Documents/myIGME/PE27/teachers.json");
            writer.Write(t);
            writer.Close();

            StreamReader reader = new StreamReader("C:/Users/timot/OneDrive/Documents/myIGME/PE27/students.json");
            s = reader.ReadToEnd();
            reader.Close();

            reader = new StreamReader("C:/Users/timot/OneDrive/Documents/myIGME/PE27/teachers.json");
            t = reader.ReadToEnd();
            reader.Close();
